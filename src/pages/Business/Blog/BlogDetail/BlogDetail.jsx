...
const BreadCrumb = lazy(() =>
  import("../../../../Shared/BreadCrumb/BreadCrumb")
);
const BlogStyleThree = lazy(() =>
  import("../../../../Shared/BlogStyleThree/BlogStyleThree")
);
const FooterReuestDemoCta = lazy(() =>
  import("../../../../Shared/FooterReuestDemoCta/FooterReuestDemoCta")
);
                ...
                <div className="blog__metas d-flex align-items-center justify-content-between clr__white">
                  <div className="singel__meta d-flex align-items-center">
                    <div className="author__avatar">
                      {businessBlogsByIdData?.author.image ? (
                        <img
                          src={businessBlogsByIdData?.author.image}
                          alt="Author"
                          className="user-img"
                        />
                      ) : (
                    ...
                    <p className="mb-0">
                      Article by:{" "}
                      <a href="#">{businessBlogsByIdData?.author.name}</a>
                    </p>
                  </div>
                  <div className="singel__meta">
                    <p className="mb-0">
                      Published:{" "}
                      <a href="#">
                        {businessBlogsByIdData?.createdAt &&
                          format(
                            new Date(businessBlogsByIdData?.createdAt),
                            "MMMM dd, yyyy"
                          )}
                      </a>
                    </p>
                ...
                <div className="author__box">
                  ...
                  <div className="author__meta d-flex align-items-center">
                    ...
                    <div className="author__ri">
                      <h5 className="mb-0">
                        {businessBlogsByIdData?.author.name}
                      </h5>
                      <div className="author__designation">
                        B2B Content Marketing Manager
                      </div>
                    </div>
                  </div>
                  <p>
                    Joe Russell is a personal finance journalist with more than
                    a decade of experience covering credit, debt, budgeting,
                    banking, investing, retirement, and more. His work has been
                    featured in the New York Times, Wall Street Journal, Yahoo,
                    Forbes, CNET, and other major publications.
                  </p>
                </div>
              </div>
